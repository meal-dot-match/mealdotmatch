          ...
          <Row>
            <Col className="how-it-works-banner-text">
              ...
              <p>
                ...
                in your kitchen and fill out our short quiz to let us know what
                you would like to cook with. We'll take care of the rest! To get
                started, click the "start now" button below. If you would like
        ...
        <Row id="instructions">
          ...
          <Col className="how-it-works-steps">
            ...
            <Col className="how-it-works-instructions-column">
              ...
              as the dairy, protein, seafood, vegetables, fruits, and grains you
          ...
          <Col className="how-it-works-steps">
            ...
            <div className="w-100" />
            <Col className="how-it-works-instructions-column">
              Based on your selections, we'll suggest recipes for you. Each will
              have a percentage score reflecting the percent of ingredients you
              have on hand. The higher the percentage, the fewer ingredients you
              are missing for that recipe.
            </Col>
          </Col>
          <Col className="how-it-works-steps">
            ...
            <div className="w-100" />
            <Col className="how-it-works-instructions-column">
              If you are missing ingredients, Meal.Match creates a shopping list
              for you and makes it easy for you to send that list to your phone.
              Simply click the "Send to Phone" option on the recipe page, and
              you'll receive a text with your missing ingredients.
            </Col>
          </Col>
        </Row>
      </Container>
